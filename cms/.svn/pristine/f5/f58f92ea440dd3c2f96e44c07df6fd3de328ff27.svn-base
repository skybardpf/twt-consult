...
{/if}
<br />
<a href="{$root_url}news/">Назад</a>&nbsp&nbsp&nbsp
<a href="{$root_url}comments/add/type/news/pid/{$id}/page/news/item/{$id}">Комментировать</a>
<br /><br /><br />
<table>
