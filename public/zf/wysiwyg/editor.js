/***********************************************************
InnovaStudio WYSIWYG Editor 3.5
...
function InnovaEditorUtil()
  ...
  for(var i=0;i<oScripts.length;i++)
    ...
    if(sSrc.indexOf("wysiwyg/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/ig,"");
    }
...
function InnovaEditor(oName)
  ...
  for(var i=0;i<oScripts.length;i++)
    {
    var sSrc=oScripts[i].src.toLowerCase();
    if(sSrc.indexOf("wysiwyg/editor.js")!=-1) this.scriptPath=oScripts[i].src.replace(/editor.js/,"");
    }
...
function fullScreen()
  ...
  if(this.stateFullScreen)
    ...
    eval("idArea"+this.oName).style.position="absolute";
    eval("idArea"+this.oName).style.top='0px';
    eval("idArea"+this.oName).style.left='0px';
