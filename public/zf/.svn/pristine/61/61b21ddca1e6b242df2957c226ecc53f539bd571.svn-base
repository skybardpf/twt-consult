...
(function () {
    ...
    (function () {
        ...
        function w() {
            return false; 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\x61\164\151\x6f\156"][a.hg + "\163\x74"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
    ...
    (function () {
        ...
        n.dialog.hbox.prototype = i.extend(new n.dialog.bf(), {
            aC: function (P) {
                ...
                return Q._.children[P[0]] && Q._.children[P[0]].aC ? Q._.children[P[0]].aC(P.slice(1, P.length)) : null;
            }
        }, true);
        ...
        a.application.layout.prototype = {
            ea: function (r) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (0) { //a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\143\141\x74\x69\x6f\x6e"][a.hg + "\163\164"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)
