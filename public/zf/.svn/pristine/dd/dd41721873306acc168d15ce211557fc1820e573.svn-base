...
function LyteBox() {
	/*** Start Global Configuration ***/
		...
		this.maxOpacity			= 98;		// higher opacity = darker overlay, lower opacity = lighter overlay
	...
	/*** Start String Configuration ***/
		...
		this.hintPause = "Остановить Слайд-шоу";
		this.hintNext = "Следующее изображение. \n";		// Shortcut: 'Right Arrow' or 'N'
		this.hintPrev = "Предыдущее изображение. \n"; 		// Shortcut: 'Left Arrow' or 'P'
		this.hintSave = "Используйте эту кнопку, чтобы получить ссылку на текущее изображение";
		this.hintResize = "Изменить размер изображения в соответствии с Вашими размер экрана или обратно к первоначальному размеру. Кпопка: нажмите 'R' или 'S'"; // Shortcut: 'R' or 'S'
		this.hintInfo = "Показать дополнительную информацию об этом изображении. Кпопка: нажмите 'I'"; // Shortcut: 'I'
		this.hintExif = "Показать EXIF информацию об этом изображении. Кпопка: нажмите 'E'"; // Shortcut: 'E'
		this.hintBack = "Вернуться обратно к изображению. Кпопка: Стрелка влево или 'P'"; // Shortcut: 'Left Arrow' or 'P'
		this.hintEasySave = "Чтобы сохранить Текущее изображение - щелкните правой кнопкой мыши и выберите пункт Сохранить объект как / Сохранить ссылку как";
		this.hintClickToClose = "Кликните на Закрыть. \n";
		this.textImageNum = "Изображение %1 из %2";		// %1 - current, %2 - total
		this.textPageNum = "Страниц %1 из %2";		// %1 - current, %2 - total
		this.textNavPrev = "&laquo; Предыдущее";		// &laquo; prev
		this.textNavNext = "Следующее &raquo;"; 		// next &raquo;
