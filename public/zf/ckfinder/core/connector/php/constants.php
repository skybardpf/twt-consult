...
if (file_exists('./../../../../../../site/conf/cms.ckfinder.config.php')) {
    define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH',"./../../../../../../site/conf/cms.ckfinder.config.php");
} else {
    define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH',"./../../../../../../cms/conf/ckfinder.config.php");
}
