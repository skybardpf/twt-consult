...
class CKFinder_Connector_Core_Config
{
    ...
    public function forceTransliterate(){
	...
	*/
    ...
    private function loadValues()
    {
        ...
        if (isset($GLOBALS['config']['Transliterate'])) {
            $this->_transliterate = CKFinder_Connector_Utils_Misc::booleanValue($GLOBALS['config']['Transliterate']);
        }
    }
